  ...
  async function fetchSlots() {
    ...
    try {
      const res = await fetch(
        `/api/slots?resourceType=lane&date=${selectedDate}`
      )
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground">
              High-intensity batting practice with match-like deliveries. Take
              your game to the next level with realistic match simulation.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-muted/20 py-12 md:py-16">
        <div className="container mx-auto px-4">
          <h2 className="mb-8 text-center text-2xl font-bold md:text-3xl">
            Why Choose Side Arm Training?
          </h2>
          <div className="mx-auto grid max-w-4xl gap-6 sm:grid-cols-3">
            <Card className="p-6">
              <Flame className="mb-3 h-8 w-8 text-primary" />
              <h3 className="mb-2 font-semibold">High Intensity</h3>
            ...
            <Card className="p-6">
              ...
              <h3 className="mb-2 font-semibold">Skill Development</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <Card className="p-6">
              ...
              <h3 className="mb-2 font-semibold">Competition Ready</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <Card className="border-yellow-500/50 bg-yellow-50 dark:bg-yellow-950/20">
              <CardContent className="flex gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Side arm sessions are best suited for players who have some
                    cricket experience. If you're new to cricket, we recommend
                    starting with lane hire or group sessions first.
                  </p>
                </div>
              </CardContent>
            </Card>
