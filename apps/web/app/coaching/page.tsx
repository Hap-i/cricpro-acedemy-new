...
export const metadata: Metadata = {
  ...
  description: "Personalised cricket coaching from experienced coaches. Tailored training programmes to accelerate your development.",
};
  ...
  return (
    <main className="min-h-screen">
        ...
        <div className="container px-4">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground">
              Personalised coaching from experienced coaches. Accelerate your development
              with tailored feedback and training programmes designed around your goals.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16">
        <div className="container px-4">
          <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">What You'll Get</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <Card className="p-6">
              <User className="h-8 w-8 text-primary mb-3" />
              <h3 className="font-semibold mb-2">Personalised Attention</h3>
          ...
          <div className="max-w-2xl mx-auto text-center">
            <Card className="border-primary">
              <CardContent className="p-8">
                ...
                <h3 className="text-2xl font-bold mb-4">One-to-One Coaching</h3>
                <p className="text-muted-foreground mb-6">
                  We're finalising our coaching programmes and pricing.
                  Submit an enquiry to be notified when we launch and get priority booking.
                </p>
              </CardContent>
            </Card>
          </div>
                ...
                <form className="space-y-6">
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="age" type="number" placeholder="Player's age" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="social">Social Player - Casual cricket</SelectItem>
                        <SelectItem value="club">Club Cricketer - Regular club player</SelectItem>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="goals" placeholder="What do you want to achieve from coaching?" />
                  </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select>
                        ...
                        <SelectContent>
                          <SelectItem value="weekday-am">Weekday mornings</SelectItem>
                          <SelectItem value="weekday-pm">Weekday evenings</SelectItem>
                          <SelectItem value="weekend-am">Weekend mornings</SelectItem>
                          <SelectItem value="weekend-pm">Weekend afternoons</SelectItem>
