        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground">
              Refine your batting technique with focused repetition using our
              professional bowling machine. Perfect for building consistency and
              confidence.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-2">
            <Card className="border-2 border-muted">
              ...
              <CardContent>
                <div className="mb-2 text-4xl font-bold text-primary">£22</div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto grid max-w-5xl gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <Card className="p-6">
              ...
              <h3 className="mb-2 font-semibold">Consistent Deliveries</h3>
            ...
            <Card className="p-6">
              ...
              <h3 className="mb-2 font-semibold">Rapid Improvement</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <Card className="p-6">
              ...
              <h3 className="mb-2 font-semibold">Flexible Pacing</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <Card className="p-6">
              ...
              <h3 className="mb-2 font-semibold">Safe Environment</h3>
              <p className="text-sm text-muted-foreground">
      ...
      <section className="bg-muted/20 py-12">
        <div className="container px-4 text-center">
          <p className="mb-4 text-muted-foreground">
            First time using a bowling machine? We'll provide a full safety
            briefing.
          </p>
